...
def random_corporate(agent_id, corporate_type, static_map, model, country=None):
    ...
    if country == 'A':
        ...
        currencyB = int(amount_B * level / 2) * 100

        cost_currencyA = int(np.random.uniform((corporate_type.params.costs_min + corporate_type.params.costs_max)/2, corporate_type.params.costs_max + 1)*0.175) 
        cost_currencyB = int(np.random.uniform(corporate_type.params.costs_min, (corporate_type.params.costs_min + corporate_type.params.costs_max)/2)*100) * 1.2
        ...
        cost_currencyA = int(np.random.uniform(corporate_type.params.costs_min, (corporate_type.params.costs_min + corporate_type.params.costs_max)/2)*0.175) 
        cost_currencyB = int(np.random.uniform((corporate_type.params.costs_min + corporate_type.params.costs_max)/2, corporate_type.params.costs_max + 1)*100) * 1.2
...
def random_bank(agent_id, bank_type, init_pos, model):
    ...
    if y < 60: 
        ...
        cost_currencyA = int(np.random.uniform(bank_type.params.local_costs_min, bank_type.params.local_costs_max + 1)*0.7)
    ...
    # if it is a bank in country B --> JAPAN
        ...
        cost_currencyA = int(np.random.uniform(bank_type.params.foreign_costs_min, bank_type.params.foreign_costs_max + 1)*0.7)
